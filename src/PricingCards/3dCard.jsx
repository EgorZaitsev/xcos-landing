...
export const CardContainer = ({ children, className, containerClassName }) => {
  ...
  return (
    <MouseEnterContext.Provider value={[isMouseEntered, setIsMouseEntered]}>
      <div
        className={`lg:py-20 flex items-center justify-center ${containerClassName}`}
        style={{
          perspective: "1000px",
        }}
      >
...
export const CardBody = ({ children, className }) => {
  return (
    <div
      className={`w-[300px] h-[380px] [transform-style:preserve-3d] [&>*]:[transform-style:preserve-3d] ${className}`}
    >
      {children}
    </div>
  );
